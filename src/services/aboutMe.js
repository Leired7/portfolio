const aboutMe = [
  ...
  {
    description:
      'Me considero un persona activa y con muchas ganas de aprender (si es en un ambiente cooperativo mejor \u{1F604}), me encanta comprender como funcionan las tecnologías. Me gusta resolver los problemas analizando de donde vienen y sopesando las diferentes soluciones hasta encontrar la más adecuada.',
  },
  {
    description:
      'Para trabajar en desarrollo web creo que son unos antecedentes fantásticos... Tengo motivación, energía y responsabilidad para encarar nuevos proyectos y encontrarles soluciones.',
  },
  {
    description:
